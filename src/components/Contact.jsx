    ...
    <div
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="mt-3 mb-8 text-zinc-400 max-w-[50ch] lg:max-w-[30ch] reveal-up">I'm available for work and collaboration opportunities. Let's build something amazing together!</p>
        ...
        <form
          action="https://getform.io/f/bjjjdvdb"
          method="POST"
          className="lg:pl-10 2xl:pl-20">
